...
if __name__ == "__main__":
    ...
    if st.session_state.auth:
     ...
     #   llm_without_rag = ChatOpenAI(model="gpt-4-1106-preview")
        ...
        st.markdown(
            "Answers with [Couchbase logo](https://emoji.slack-edge.com/T024FJS4M/couchbase/4a361e948b15ed91.png) are generated using *RAG* while [OpenAI logo](https://static-00.iconduck.com/assets.00/openai-icon-253x256-bamv50yy.png) are generated by pure *LLM (ChatGPT)*"
        )
        ...
        with st.sidebar:
            ...
            st.markdown(
                ...
                * one using pure LLM - OpenAI ([OpenAI logo](https://static-00.iconduck.com/assets.00/openai-icon-253x256-bamv50yy.png)).
                """
            )
